...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.secret_increment) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named secret_increment');
    }
  ...
  _secret_increment_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.secret_increment(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('secret_increment',
                                 'return value',
  ...
  _increment_0(context, partialProofData) {
    const amount_0 = this._secret_increment_0(context, partialProofData);
    __compactRuntime.assert(amount_0 > 0n, 'Increment must be strictly positive');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
...
const _dummyContract = new Contract({
  secret_increment: (...args) => undefined
});
